...
const Card = () =>{
    return(
        <Content>
            <h1>OUR TEAM</h1>
            <Wrapper>
               <Cards img="https://firebasestorage.googleapis.com/v0/b/edhf-nigeria.appspot.com/o/elisha.jpg?alt=media&token=b2337beb-1c4f-46b3-8a79-e57f237bfb56" name="Elisha Ajose" text="FOUNDER/CHAIRMAN"/>
