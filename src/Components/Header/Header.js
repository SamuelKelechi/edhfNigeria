...
const Header = () => {
  ...
  return (
    <HeaderContainer>
        <HeaderWrapper>
            <NavLinks to='/' ><LogoImg src="https://firebasestorage.googleapis.com/v0/b/edhf-nigeria.appspot.com/o/Logo.png?alt=media&token=ae442336-32ea-4892-bfd5-f690c4fc72f5"/></NavLinks>
